...
\begin{document}
	...
	% Put pictures of test circuits! (create your own as well as the provided ones…)
	...
	\captionof{table}{Number of iterations versus $\omega$.}  % TODO: fix table caption
	\csvautotabular{csv/q3b_iterations.csv}
